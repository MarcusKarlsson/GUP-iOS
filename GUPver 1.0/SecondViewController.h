...
@interface SecondViewController : UIViewController<UIPopoverControllerDelegate,UITableViewDataSource,UITableViewDelegate,UISearchBarDelegate,UITextFieldDelegate,MBProgressHUDDelegate,NewGroupCellDelegate,UINavigationControllerDelegate,LocalityDelegate>
{
    ...
    NSMutableArray *selectedGroup,*groupData,*filteredData;
    NSInteger expndRow;
