...
- (void)viewDidLoad{
    ...
    uploadprogress=[[UIProgressView alloc]initWithFrame:CGRectMake(20, 35, deviceSize.width-100-40, 50)];
    ...
    progressViewBackground=[[UIView alloc]initWithFrame:CGRectMake(0, 0, deviceSize.width-100, 50)];
    ...
    uploadlable=[[UILabel alloc]initWithFrame:CGRectMake(10, 5,deviceSize.width-120 , 20)];
    ...
    menuView = [[UIView alloc] initWithFrame:CGRectMake(0, deviceSize.height-80-64, deviceSize.width, 80)];
    ...
    userIcon =[[UIImageView alloc]initWithFrame:CGRectMake(10, 8, 40, 40)];
    userIcon.layer.cornerRadius = 20;
    userIcon.clipsToBounds = YES;
    [menuView addSubview:userIcon];
    
    UIButton* _postButton = [[UIButton alloc] initWithFrame: CGRectMake(deviceSize.width-50, 13, 40, 30.0f)];
    ...
    _postButton.titleLabel.font = [UIFont fontWithName:@"Dosis-Bold" size:14];
    _postButton.layer.cornerRadius = 8;
    _postButton.backgroundColor = [UIColor colorWithRed:255.0/255.0 green:207.0/255.0 blue:13.0/255.0 alpha:1];
    [menuView addSubview:_postButton];
    ...
    textView = [[UITextView alloc] initWithFrame:CGRectMake(60, 8, self.view.bounds.size.width-120, 40)];
    textView.text = @"Type your message....";
    ...
    submenuView = [[UIView alloc] initWithFrame:CGRectMake(0, 55, deviceSize.width, 25)];
    ...
    _tabBarView.frame = CGRectMake(0, accessoryView.frame.origin.y-49, deviceSize.width, accessoryTab.frame.size.height);
...
-(void)viewWillDisappear:(BOOL)animated{
    ...
    [self appDelegate]._messageDelegate=nil;
}
...
//            NSString *timestamp = [NSString stringWithFormat:@"%@",[[NSString getCurrentUTCFormateDate] getTimeIntervalFromUTCStringDate]];
            ...
            UIImage* image = [UIImage imageWithData:fileToBeUploaded];
            CGSize imgSize = image.size;
            NSLog(@"Image width = %d, height = %d", (int)imgSize.width, (int)imgSize.height);
...
{
    imageBG = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height)];
    imageBG.backgroundColor = [UIColor blackColor];
    imageBG.userInteractionEnabled = YES;
    imageBG.alpha = 0.1;

    UIView *tappedView = [gesture.view hitTest:[gesture locationInView:gesture.view] withEvent:nil];
    UIImage* image = ((UIImageView*)tappedView).image;
    ...
    CGFloat imgRatio = height / width;
    CGFloat bgRatio = imageBG.frame.size.height / imageBG.frame.size.width;
    
    if (imgRatio > bgRatio) {
        height = imageBG.frame.size.height;
        width = height / imgRatio;
    } else {
        width = imageBG.frame.size.width;
        height = width * imgRatio;
    }
    
    //NSLog(@"tag val %i\n%@",tappedView.tag,tappedView);
    ImageViewerGup *iv=[[ImageViewerGup alloc]initWithFrame:CGRectMake((imageBG.frame.size.width - width) / 2, (imageBG.frame.size.height - height) / 2, width, height)];
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    if(section==0){
        ...
        UIView* border = [[UIView alloc] initWithFrame:CGRectMake(10, 0, self.chatTable.bounds.size.width-20, 40)];
        border.backgroundColor = [UIColor clearColor];
        unreadMessagelbl.frame = CGRectMake(10, 5, self.chatTable.bounds.size.width-20, 25);
        ...
        UIView* border1 = [[UIView alloc] initWithFrame:CGRectMake(10, 39.5, self.chatTable.bounds.size.width-20, .5)];
...
- (IBAction)sendMessage{
    ...
    if([msgCheck length]!=0 && ![textView.text isEqualToString:@"Type your message...."]){
