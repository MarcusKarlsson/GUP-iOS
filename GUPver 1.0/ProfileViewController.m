...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)sectio{
    ...
    UILabel *about = [[UILabel alloc] initWithFrame:CGRectMake(10,5, self.view.frame.size.width - 20,20)];
    about.text =@"About Me";
    ...
    aboutme = [[UITextView alloc] initWithFrame:CGRectMake(10,25, self.view.frame.size.width - 20, 40)];
...
//    }
    ...
    UIView *border =[[UIView alloc] initWithFrame:CGRectMake(10, 69, profileTable.frame.size.width - 20, 1)];
