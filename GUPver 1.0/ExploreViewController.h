...
@interface ExploreViewController : UIViewController<UITableViewDataSource,NewGroupCellDelegate,UITableViewDelegate,UISearchBarDelegate,NSURLConnectionDelegate,MBProgressHUDDelegate,LocalityDelegate>
{
    ...
    UIButton *joinButton;
    NSURLConnection *searchConn,*addContactConn;
    NSMutableData *searchResponse,*addContactResponse;
