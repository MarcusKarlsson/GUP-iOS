...
//                [verifyNoti show];
                ...
                AppDelegate *appDelegateObj = (AppDelegate *)[[UIApplication sharedApplication] delegate];
                if (!email_verified){
                    UIAlertView *verifyNoti=[[UIAlertView alloc]initWithTitle:Nil message:[NSString stringWithFormat:@"Verification Pending,Verification Link will Expire in %i Days",noOfDays] delegate:appDelegateObj.firstViewController cancelButtonTitle:@"OK" otherButtonTitles:@"Resend E-mail", nil];
            ...
            [self freezerRemove];
            AppDelegate *appDelegateObj = (AppDelegate *)[[UIApplication sharedApplication] delegate];
            UIAlertView *verifyNoti=[[UIAlertView alloc]initWithTitle:Nil message:responce[@"error_message"] delegate:appDelegateObj.firstViewController cancelButtonTitle:@"OK" otherButtonTitles:@"Resend E-mail", nil];
