...
@interface PostListing : UIViewController<UITableViewDataSource,UITableViewDelegate,MBProgressHUDDelegate,PostCellDelegate,XMPPRoomDelegate,UIAlertViewDelegate>{
