...
-(void)listGroupsAssociatedToCategory
{
    ...
    NSString *postData = [NSString stringWithFormat:@"category_id=1&user_id=%@&latitude=%f&longitude=%f",[[DatabaseManager getSharedInstance]getAppUserID], latitude, longitude];
    NSLog(@"$[%@]",postData);
