...
- (void)viewDidLoad{
    ...
    [menuView addSubview:userIcon];
     ...
     UIButton* _postButton = [[UIButton alloc] initWithFrame: CGRectMake(deviceSize.width - 50, 13, 40.0f, 30.0f)];
    ...
    textView = [[UITextView alloc] initWithFrame:CGRectMake(60, 8, deviceSize.width-120, 40)];
...
- (void)sendMessage{
    ...
    if([msgCheck length] > 0 && ![textView.text isEqualToString:@"Type your comment...."]){
